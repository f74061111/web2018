...
<?php
    $day = date("ymd");
    $dayTemp[21] = date("ymd");
    $weekToday = (int)date("N");
    for($x = 0; $x < 21; $x++){
        $addDay = $x - $weekToday + 1;
        $dayTemp[$x] = DateTime::createFromFormat('ymd', $day);
        $dayTemp[$x] ->modify("+".$addDay." day");
        $dayTemp[$x]  =  $dayTemp[$x]->format("md");
    }
    for($x = 0; $x < 14; $x++){
    ...
    <table align='center'>
        <tr bgcolor='#F5F5DC'>
            ...
            <th colspan='5' id=date> 
                2018$dayTemp[0]~2018$dayTemp[6]
            </th>
            <th colspan='2'> 
    ...
    echo "
        <tr bgcolor='#f2f2f2'>
            <th>圖片</th>
            <th>房型</th>
            <th id= day1>一 ".$dayTemp[0]."</th>
            <th id= day2>二 ".$dayTemp[1]."</th>
            <th id= day3>三 ".$dayTemp[2]."</th>
            <th id= day4>四 ".$dayTemp[3]."</th>
            <th id= day5>五 ".$dayTemp[4]."</th>
            <th id= day6>六 ".$dayTemp[5]."</th>
            <th id= day7>日 ".$dayTemp[6]."</th>
        </tr>
    ";    
    for($y = 0; $y < 6; $y++){
        for($x = 0; $x <= 7; $x++){
    ...
    echo"
            ...
            function leftFcn() {
                ...
                if(page > 1){
                    ...
                    //window.alert(page);
                    if(page == 1){
                        var b = document.getElementById('day1');
                        var d = document.getElementById('date');
                        d.innerHTML = '2018".$dayTemp[0]."~2018".$dayTemp[6]."';
                        b.innerHTML = '一 ".$dayTemp[0]."';
                        b = document.getElementById('day2');
                        b.innerHTML = '二 ".$dayTemp[1]."';
                        b = document.getElementById('day3');
                        b.innerHTML = '三 ".$dayTemp[2]."';
                        b = document.getElementById('day4');
                        b.innerHTML = '四 ".$dayTemp[3]."';
                        b = document.getElementById('day5');
                        b.innerHTML = '五 ".$dayTemp[4]."';
                        b = document.getElementById('day6');
                        b.innerHTML = '六 ".$dayTemp[5]."';
                        b = document.getElementById('day7');
                        b.innerHTML = '日 ".$dayTemp[6]."';
    ...
    echo"
                        var b = document.getElementById('day1');
                        var d = document.getElementById('date');
                        d.innerHTML = '2018".$dayTemp[7]."~2018".$dayTemp[13]."';
                        b.innerHTML = '一 ".$dayTemp[7]."';
                        b = document.getElementById('day2');
                        b.innerHTML = '二 ".$dayTemp[8]."';
                        b = document.getElementById('day3');
                        b.innerHTML = '三 ".$dayTemp[9]."';
                        b = document.getElementById('day4');
                        b.innerHTML = '四 ".$dayTemp[10]."';
                        b = document.getElementById('day5');
                        b.innerHTML = '五 ".$dayTemp[11]."';
                        b = document.getElementById('day6');
                        b.innerHTML = '六 ".$dayTemp[12]."';
                        b = document.getElementById('day7');
                        b.innerHTML = '日 ".$dayTemp[13]."';
                            var b = document.getElementById('".$x."Button');
                            if($x%7 == 0)
                                a = 7;
                            else
                    ...
                    if(page == maxPage){
                        switch (page){
                            ...
                            case 3:
                                var b = document.getElementById('day1');
                                var d = document.getElementById('date');
                                d.innerHTML = '2018".$dayTemp[14]."~2018".$dayTemp[20]."';
                                b.innerHTML = '一 ".$dayTemp[14]."';
                                b = document.getElementById('day2');
                                b.innerHTML = '二 ".$dayTemp[15]."';
                                b = document.getElementById('day3');
                                b.innerHTML = '三 ".$dayTemp[16]."';
                                b = document.getElementById('day4');
                                b.innerHTML = '四 ".$dayTemp[17]."';
                                b = document.getElementById('day5');
                                b.innerHTML = '五 ".$dayTemp[18]."';
                                b = document.getElementById('day6');
                                b.innerHTML = '六 ".$dayTemp[19]."';
                                b = document.getElementById('day7');
                                b.innerHTML = '日 ".$dayTemp[20]."';
                                break;
                        }
